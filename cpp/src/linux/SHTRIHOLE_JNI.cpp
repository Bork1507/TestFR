...
JNIEXPORT jint JNICALL Java_SHTRIHOLE_1JNI_nativeCheckSubTotal (JNIEnv *jenv, jobject jobj){
    long error = 0;

    return error;
}

JNIEXPORT jint JNICALL Java_SHTRIHOLE_1JNI_nativeCloseCheck (JNIEnv *jenv, jobject jobj, jstring pay1, jstring pay2, jstring pay3, jstring pay4, jstring text){
    long error = 0;

    return error;
}

JNIEXPORT jint JNICALL Java_SHTRIHOLE_1JNI_nativeCancelCheck (JNIEnv *jenv, jobject jobj){
    long error = 0;
