...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeConnect (JNIEnv *jenv, jobject jobj, jint portNumber, jint baud){
   ...
   char* szProgID = (char*)"SP101FRKLib.SP101FRObject_1C";
   ...
   hr = pUnk->QueryInterface( IID_ISP101FRObject_1C, (LPVOID*)&pOleFR );
   pUnk->Release();
   if ( FAILED( hr ))
   {
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeCutAndPrint (JNIEnv *jenv, jobject jobj){
    short error = 0;
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeGetPrinterStatus (JNIEnv *jenv, jobject jobj){
    short error = 0;
    long result = 0;

    if (error == 0) error=pOleFR->GetPrinterStatus();
    if (error == 0) result=pOleFR->PrinterStatus();
...
//    return error;
//}
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeXreport (JNIEnv *jenv, jobject jobj, jstring operatorName){
    short error = 0;
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeZreport (JNIEnv *jenv, jobject jobj, jstring operatorName){
    short error = 0;
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeJournalPrint (JNIEnv *jenv, jobject jobj, jstring operatorName){
    short error = 0;
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativePrintJournal (JNIEnv *jenv, jobject jobj, jstring operatorName){
    short error = 0;
...
JNIEXPORT jstring JNICALL Java_SPOLE1C_1JNI_nativeJournalRead (JNIEnv *jenv, jobject jobj, jint operation, jint parameter){
    short error = 0;
    BSTR bstrResult;
    char cResult[100];
    for (int i=0;i<100;i++)cResult[i]=0;

    if (error == 0) error=pOleFR->JournalRead(operation, parameter);
    if (error == 0) bstrResult=pOleFR->JournalRecordData();
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeGetJournalNumber (JNIEnv *jenv, jobject jobj){
    short error = 0;
    short journalNumber = 0;

    if (error == 0) error=pOleFR->GetJournalNumber();
    if (error == 0) journalNumber=pOleFR->JournalNumber();
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeGetJournalRecordCount (JNIEnv *jenv, jobject jobj){
    short error = 0;
    short recordCount = 0;

    if (error == 0) error=pOleFR->GetJournalRecordCount(&recordCount);
    if (error == 0) recordCount=pOleFR->JournalRecordCount();
...
JNIEXPORT jstring JNICALL Java_SPOLE1C_1JNI_nativeGetJournalRecord (JNIEnv *jenv, jobject jobj, jint RecordNumber){
    short error = 0;
    BSTR bstrResult;
    char cResult[100];
    for (int i=0;i<100;i++)cResult[i]=0;

    if (error == 0) error=pOleFR->GetJournalRecord(RecordNumber);
    if (error == 0) bstrResult=pOleFR->JournalRecordData();
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeGetJournalReceiptByIndex (JNIEnv *jenv, jobject jobj, jint ReceiptIndex){
    short error = 0;
    short recordNumber = 0;

    if (error == 0) error=pOleFR->GetJournalReceiptByIndex(ReceiptIndex);
    if (error == 0) recordNumber=pOleFR->JournalRecordNumber();
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeGetJournalReceiptByNumber (JNIEnv *jenv, jobject jobj, jint ReceiptNumber){
    short error = 0;
    short recordNumber = 0;

    if (error == 0) error=pOleFR->GetJournalReceiptByNumber(ReceiptNumber);
    if (error == 0) recordNumber=pOleFR->JournalRecordNumber();
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeZCopy (JNIEnv *jenv, jobject jobj, jint operation, jint parameter)
{
    short error = 0;
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeZCopyClear (JNIEnv *jenv, jobject jobj)
{
    short error = 0;
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeZCopyPrintRegistration (JNIEnv *jenv, jobject jobj)
{
    short error = 0;
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeZCopyPrintAll (JNIEnv *jenv, jobject jobj)
{
    short error = 0;
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeZCopyPrintByOrderNumber (JNIEnv *jenv, jobject jobj, jint OrderNumber)
{
    short error = 0;
...
JNIEXPORT jint JNICALL Java_SPOLE1C_1JNI_nativeZCopyPrintByShiftNumber (JNIEnv *jenv, jobject jobj, jint ShiftNumber)
{
    short error = 0;
