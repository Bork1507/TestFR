...
C:\Progra~2\Java\jdk1.8.0_91\bin\javah -d cpp\src -classpath bin SHTRIHDRV_JNI
echo "Compiling libraries for JNI..."
g++ -shared -Wl,--kill -IC:/Progra~2/Java/jdk1.8.0_91/include -IC:/Progra~2/Java/jdk1.8.0_91/include/win32 -I./cpp/src/ ./cpp/src/windows/SHTRIHDRV_JNI.cpp -o ./java/lib/windows/SHTRIHDRV_JNI.dll -lole32 -luuid -loleaut32
rem pause
